...
function getStats() {
    $.ajax(statsURL).then(function (data) {
        ...
        // now that JS tests for position, it can properly log the correct statistical categories for the player
...
// the following JS event listeners enable different CSS styles. Instead of doing a "dark mode", I wanted to create different settings
// based on favorite team. This is still a WIP, as it only features the Chargers, Bengals, and Falcons.
